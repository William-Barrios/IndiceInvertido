...
int main(int argc, const char* argv[]) {
    ...
    while (processedBytes < fileSize) {
        ...
        while (step < active) {
            ...
            step *= 2;
            // recorta active a último no vacío
            while (active > 0 && threadMaps[active - 1].empty()) --active;
        }
    ...
    vector<pair<string, palabra>> sortedWords(finalMap.begin(), finalMap.end());
    ...
    sort(sortedWords.begin(), sortedWords.end(),
        ...
        */
    // Imprimir primeras N palabras ordenadas
    ...
    if (archivo.is_open()) {
        ...
        archivo << "Total de palabras únicas: " << sortedWords.size() << endl;
        archivo << "Total de palabras procesadas: " << nextWordPosition.load() - 1 << endl;
        archivo << "\nPalabras encontradas (ordenadas por frecuencia):" << endl;
        ...
        archivo.close();
        cout << "Resultados guardados en: C://Users//Usuario//Documents//big_data//resultado2.txt" << endl;
    }
}
